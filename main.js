...
// Compares each nav link's href against the current filename and
// adds .current automatically — no need to hand-set it per page.
// The cesto link (href="#", a drawer trigger, not a real page)
// naturally never matches, so it's never marked current.
// =========================================================
